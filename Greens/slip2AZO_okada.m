function zout=slip2AZO_okada(XIN,YIN,zin,look_e,look_n,look_z,slip_model_in)
%
%  Usage: 
%     los_out=slip2AZO_okada(XIN,YIN,zin,los_in,look_e,look_n,look_z,slip_model_in);
%    
%%%%% input
...
zout_good=ue.*sind(theta_az)+un.*cosd(theta_az);
