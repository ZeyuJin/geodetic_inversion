function G=calc_green_gps_3d_okada(data_slip_model,data_gps);
%  
% Usage: G=calc_green_gps_okada(data_slip_model,data_gps);
%   
%  data_gps=[xe_gps,yn_gps,ue,un,uz];
...
Nstn=length(xe_gps);
Nobs=3*Nstn; % use 3 components of the GPS observations
G=zeros(Nobs,Npara);
...
for k=1:Npatch;
   ...
   U1_green_gps=[ue1;un1;uz1];
   U2_green_gps=[ue2;un2;uz2];
   G(:,k)=U1_green_gps;
