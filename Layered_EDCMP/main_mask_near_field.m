...
% mask_near_field('resample/misfit_include_MAI/homo_all_data.mat','ASC100/LOS/los_samp1.mat','all_faults',200,'ASC100_los');
% mask_near_field('resample/misfit_include_MAI/homo_all_data.mat','DES5/LOS/los_samp1.mat','all_faults',200,'DES5_los');
% mask_near_field('resample/misfit_include_MAI/homo_all_data.mat','ALOS2_SCAN/los_samp1.mat','all_faults',200,'DES57_los');
% mask_near_field('resample/misfit_include_MAI/homo_all_data.mat','ALOS2_stripe/LOS/los_samp1.mat','all_faults',200,'ASC163_los');
% mask_near_field('resample/misfit_include_MAI/homo_all_data.mat','ALOS2_stripe/MAI2/los_samp1.mat','all_faults',200,'ASC163_MAI');