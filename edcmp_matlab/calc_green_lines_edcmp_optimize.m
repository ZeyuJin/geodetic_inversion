function G=calc_green_lines_edcmp_optimize(slip_model,data_insar,finp)
...
%       end
      ...
      linearI1 = sub2ind([nr+2,nz+2], idis(1:nps), iz(1:nps));
      linearI2 = sub2ind([nr+2,nz+2], idis(1:nps)+1, iz(1:nps));
      linearI3 = sub2ind([nr+2,nz+2], idis(1:nps), iz(1:nps)+1);
      linearI4 = sub2ind([nr+2,nz+2], idis(1:nps)+1, iz(1:nps)+1);
      
      AA1(1:nps) = ssu1(linearI1);
      AA2(1:nps) = ssu1(linearI2);
      AA3(1:nps) = ssu1(linearI3);
      AA4(1:nps) = ssu1(linearI4);
...
%       end
      ...
      AA1(1:nps) = ssu2(linearI1);
      AA2(1:nps) = ssu2(linearI2);
      AA3(1:nps) = ssu2(linearI3);
      AA4(1:nps) = ssu2(linearI4);      
...
%       end
      AA1(1:nps) = ssu3(linearI1);
      AA2(1:nps) = ssu3(linearI2);
      AA3(1:nps) = ssu3(linearI3);
      AA4(1:nps) = ssu3(linearI4);      
...
%       end
      AA1(1:nps) = dsu1(linearI1);
      AA2(1:nps) = dsu1(linearI2);
      AA3(1:nps) = dsu1(linearI3);
      AA4(1:nps) = dsu1(linearI4); 
...
%       end
      AA1(1:nps) = dsu2(linearI1);
      AA2(1:nps) = dsu2(linearI2);
      AA3(1:nps) = dsu2(linearI3);
      AA4(1:nps) = dsu2(linearI4);
...
%       end
      AA1(1:nps) = dsu3(linearI1);
      AA2(1:nps) = dsu3(linearI2);
      AA3(1:nps) = dsu3(linearI3);
      AA4(1:nps) = dsu3(linearI4);
...
%       end
      AA1(1:nps) = clu1(linearI1);
      AA2(1:nps) = clu1(linearI2);
      AA3(1:nps) = clu1(linearI3);
      AA4(1:nps) = clu1(linearI4);      
...
%       end
      AA1(1:nps) = clu2(linearI1);
      AA2(1:nps) = clu2(linearI2);
      AA3(1:nps) = clu2(linearI3);
      AA4(1:nps) = clu2(linearI4);
